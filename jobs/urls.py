...
from jobs.views.job_item_view import ItemSet
from jobs.views.job_location_date_posted_item_view import JobLocationDatePostedItemSet
...
router.register(r'job_location_items', JobLocationDatePostedItemSet, basename="job_location_item"),
router.register(r'job_items', ItemSet, basename="job_item"),
